...
// Draw boundingRect and write axis in textfile
...
int main()
{
	Mat src = imread("./images/yourimage-unsharp-mask-binary-ed.jpg", IMREAD_COLOR);
...
void thresh_callback(int, void* )
{
	...
	imwrite("./images/yourimage-unsharp-mask-binary-ed-rect.jpg", drawing);
}
