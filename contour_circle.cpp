...
int main()
{
	string filename = "../data/image_processing/src2/cosmobio_rgb1-unsharp-mask2.jpg";
...
void thresh_callback(int, void*)
{
	...
	//////////////////////////////////////////////////
	freopen("../data/image_processing/output_circle_green.txt", "w", stdout);
	...
	for(size_t i = 0; i< contours.size(); i++)
	{
		...
		circle(drawing, center[i], (int)radius[i], color3, 2, 8, 0);
		cout << center[i] << radius[i] << endl;

	}
	
	namedWindow("Contours", WINDOW_AUTOSIZE);
	imshow("Contours", drawing);
	imwrite("../data/image_processing/src2/cosmobio_rgb1-unsharp-mask2_circle.jpg", drawing);
}
