...
int main()
{
	for (int j=1; j<=100; j++)
	{
		...
		//////////////////////////////////////////////////
		string result_data = "../data/image_processing/output_circle_all" + to_string(j) + ".txt";
		...
		for(size_t i = 0; i< contours.size(); i++)
		{
			...
			//////////////////////////////
			// Draw circles with color2 //
			//////////////////////////////
			circle(drawing, center[i], (int)radius[i], color4, 2, 8, 0);
		...
		///////////////////////////
		string filename_output = "../data/image_processing/src1/cosmobio_gray" + to_string(j) + "-unsharp-de-circle.jpg";
